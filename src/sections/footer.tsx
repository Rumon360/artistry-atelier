...
const FooterLinkSection = ({
  ...
  <div>
    <p className="font-medium cursor-pointer underline-hover">{title}</p>
...
function Footer() {
  return (
    <footer className="bg-[var(--foreground)] text-[var(--background)] wp">
      <div className="space-y-8 px-4 py-16 sm:px-6 lg:space-y-16 lg:px-8">
        <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
          <div>
            <p
              style={{ textIndent: "10%" }}
              className="max-w-xs text-sm uppercase relative"
            >
              <sup
                style={{
                  fontSize: "30px",
              ...
              Discover the unique advantage of partnering with Artistry Atelier.
              We&apos;re here to be your reliable ally in the art world.
            </p>
        ...
        <p className="text-xs text-gray-500">
          &copy; 2024. Artistry Atelier. All rights reserved.
        </p>
      </div>
    </footer>
  );
